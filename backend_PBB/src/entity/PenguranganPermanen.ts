...
@Entity("PENGURANGAN_PERMANEN", { schema: "PBB_KUTAI BARAT" })
export class PenguranganPermanen {
  ...
  @Column("character", {
    name: "THN_PENG_PERMANEN_AWAL",
    nullable: true,
    length: 4,
  })
  thnPengPermanenAwal: string | null;
  ...
  thnPengPermanenAkhir: string | null;
  ...
  @Column("character", {
    name: "STATUS_SK_PENG_PERMANEN",
    nullable: true,
    length: 1,
  })
  statusSkPengPermanen: string | null;
  ...
  pctPenguranganPermanen: string | null;
