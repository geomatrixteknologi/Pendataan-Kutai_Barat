...
@Index("SYS_C008945", ["kdKantor", "kdKanwil", "tempNoBundel", "tempThnBundel", "tempUrutBundel"], { unique: true })
@Entity("TEMP_MAX_BUNDEL_EPELAYANAN", { schema: "PBB_KUTAI BARAT" })
export class TempMaxBundelEpelayanan {
