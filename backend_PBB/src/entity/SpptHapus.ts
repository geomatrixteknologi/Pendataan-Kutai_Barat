...
@Index("SPPT_HAPUS_PK", ["kdBlok", "kdDati2", "kdJnsOp", "kdKecamatan", "kdKelurahan", "kdPropinsi", "noUrut", "thnPajakSppt"], { unique: true })
@Entity("SPPT_HAPUS", { schema: "PBB_KUTAI BARAT" })
export class SpptHapus {
  ...
  @Column("timestamp without time zone", { name: "TGL_HAPUS", nullable: true })
  tglHapus!: Date | null;

  @Column("character", {
    name: "NIP_PEREKAM_HAPUS",
    nullable: true,
    length: 30,
  })
  nipPerekamHapus!: string | null;
}
