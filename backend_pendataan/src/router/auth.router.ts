import { deleteAccount, getMe, getRole, login, logout, register, updateUser } from "../controller/auth";
...
authRouther.put("/update/:userId", validateUpdateUser, updateUser as any);
authRouther.get("/me", getMe as any);
authRouther.get("/role", getRole as any);
authRouther.delete("/delete/:userid", deleteAccount as any);
